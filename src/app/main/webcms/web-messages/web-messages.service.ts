...
import { Discussion } from 'app/main/webcms/web-messages/models/discussion';
import { DiscussionItem } from 'app/main/webcms/web-messages/models/discussionItem';
...
export class WebMessagesService implements Resolve<any>
{
